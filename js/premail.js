var mailSystem = {
    ...
    mailVersions: [
        ...
        },
        {
            ...
            mails: [
                {
                    id: 'compensation_mail_20260831',
                    title: '账户等级及其经验值平衡性调整和商店物品内容的修改及其价格的更新 - 补偿邮件',
                    sender: 'PRE Launcher',
                    content: '亲爱的用户，您好！\n\n感谢您一直以来对 PRE Launcher 的支持与厚爱。在 2026-08-31 的更新中，我们对账户等级与经验值系统进行了平衡性调整，并对商店物品内容与价格进行了更新，具体如下：\n\n一、经验值补给卡调整：经验值补给卡 Ⅰ/Ⅱ/Ⅲ 的经验值分别调整为 300/600/1000 点，并全新推出经验值补给卡 Ⅳ（使用后获得 2000 点经验值）。\n\n二、经验值加成卡调整：经验值加成卡 Ⅰ/Ⅱ/Ⅲ 的加成幅度分别调整为 5%/15%/30%，并优化叠加机制——三种不同类型的加成卡可同时叠加生效（最高可叠加至 +50%），同类型加成卡不可叠加，最多同时叠加 3 张。\n\n三、升级公式调整：升级所需经验值调整为分档公式——1-19 级为 50+(等级+1)×30，20-49 级为 80+(等级+2)×50，50 级及以上为 100+(等级+5)×80，账户升级节奏将更加平滑合理。\n\n四、商店更新：商店新增「每月限购」与「累计限购」两个分类，每周限购分类内新增组合包商品；全新上架经验值补给卡 Ⅳ、月度特供系列商品、月度成长补给包与每周轻量补给包，并对部分商品价格进行了调整。\n\n感谢您对本次调整的理解与支持，同时我们也对此次的突然调整感到抱歉，在此之前没有通过公告或邮件来提前告知各位用户，因此我们特为您奉上补偿：自选物品兑换卡 ×1 + 经验值补给卡 Ⅳ ×1。领取邮件后自选物品兑换卡将存放至您的仓库，使用后可任选一个当前版本商店内正在售卖的物品进行兑换获取（可兑换包括之后新加入的物品，不含组合包）；经验值补给卡 Ⅳ 使用后获得 2000 点经验值，将立即对您的账户等级生效。\n\n本邮件发放对象为 2026-08-31 11:00:00 (UTC+8) 之前完成注册的账户；\n领取有效期截至 2026-09-07 23:59:59 (UTC+8)，逾期未领取将无法补发，请及时领取。\n\n祝您使用愉快！',
                    attachments: [
                        {
                            name: '自选物品兑换卡',
                            type: 'warehouse',
                            itemId: 'exchange_card',
                            count: 1
                        },
                        {
                            name: '经验值补给卡 Ⅳ',
        ...
        },
        {
            ...
            mails: [
                {
                    id: 'compensation_mail_20260905',
                    title: '2026-09-05 版本更新补偿',
                    sender: 'PRE Launcher',
                    content: '亲爱的用户，您好！\n\n在本次更新中，我们新增了全新重置改版的「音乐播放器」，并对其余功能进行了修复和优化。 \n\n感谢您一直以来对 PRE Launcher 的支持与厚爱。\n\n为感谢您在本次版本更新前已完成账户注册，我们特为您奉上版本更新补偿：经验值补给卡 Ⅰ ×1。 \n\n本邮件发放对象为 2026-09-05 16:00:00 (UTC+8) 之前完成注册的账户；\n领取有效期截至 2026-09-12 23:59:59 (UTC+8)，逾期未领取将无法补发，请及时领取。\n\n祝您使用愉快！',
                    attachments: [
                        {
                            name: '经验值补给卡 Ⅰ',
                            type: 'warehouse',
                    ...
                    startTime: "2026-09-05 16:00:00",
                    endTime: "2026-09-12 23:59:59",
                    requireRegisteredBefore: "2026-09-05 16:00:00"
                }
            ]
        },
        {
            ...
            mails: [
                {
                    id: 'compensation_mail_20260907',
                    title: '2026-09-07 版本更新补偿',
                    sender: 'PRE Launcher',
                    content: '亲爱的用户，您好！\n\n在本次更新中，我们为音乐播放器新增了完整的歌词系统（LRC 歌词滚动显示、自定义歌词文件上传）、内置调音器与均衡器面板（9 种预设混音 + 7 段 EQ + 低音/高音/立体声/主音量调节），并新增控制条收起/展开、快速跳转、重置播放器设置等功能，带来十余项体验优化与问题修复。\n\n感谢您一直以来对 PRE Launcher 的支持与厚爱。\n\n为感谢您在本次版本更新前已完成账户注册，我们特为您奉上版本更新补偿：经验值补给卡 Ⅰ ×1。经验值补给卡 Ⅰ 领取后将发放至您的仓库，使用后获得 300 点经验值，将立即对您的账户等级生效。\n\n本邮件发放对象为 2026-09-07 14:20:00 (UTC+8) 之前完成注册的账户；\n领取有效期截至 2026-09-14 23:59:59 (UTC+8)，逾期未领取将无法补发，请及时领取。\n\n祝您使用愉快！',
                    attachments: [
                        {
                            name: '经验值补给卡 Ⅰ',
                            type: 'warehouse',
                    ...
                    startTime: "2026-09-07 14:20:00",
                    endTime: "2026-09-14 23:59:59",
                    requireRegisteredBefore: "2026-09-07 14:20:00"
                }
            ]
        },
        {
        ...
        },
        {
            ...
            mails: [
                {
                    id: 'compensation_mail_20260919',
                    title: '2026-09-19 版本更新补偿',
                    sender: 'PRE Launcher',
                    content: '亲爱的用户，您好！\n\n在本次更新中，我们为启动器带来了全新「阶段突破」模式：当成长等级达到 60 级满级状态后，即可开启阶段突破将等级上限提升至全新的 120 级最高等级（启用 60-120 级全新经验值公式，等级徽章左侧显示淡红色「阶段突破」标签）；同时阶段突破模式下每日签到基础经验值提升至 300/500/750、每日基础 PRE 硬币提升至 80/120/150，签到里程碑弹窗新增「标准阶段 / 阶段突破」双阶段切换与全新的 60-120 级独立里程碑奖励（含自选物品兑换卡）；此外还新增了百宝箱「木鱼」攒功德功能（支持 DDos佛祖自动敲击）、每日签到结果弹窗展示、音乐播放器配置导入及导出功能等多项更新与优化。\n\n同时，我们已于本次更新中修复了一个经验值系统的重要问题：在超过 60 级后使用经验值补给卡，会导致页面系统直接卡死的问题。强关页面重新进入后，已使用的补给卡会被算作直接消耗，但账户经验值却没有正确提高。经排查，该 bug 可能在经验值系统更新后就已出现，直至本次更新后才被发现并修复。对于该问题给您带来的不便与损失，我们深表歉意，恳请您谅解。\n\n为弥补该问题可能造成的损失，同时感谢您在本次版本更新前已完成账户注册，我们特为您奉上版本更新补偿：经验值补给卡 Ⅰ ×1、经验值补给卡 Ⅲ ×1 和 自选物品兑换卡 ×1，所有物品领取后将发放至您的仓库。经验值补给卡 Ⅰ 使用后获得 300 点经验值，经验值补给卡 Ⅲ 使用后获得 1000 点经验值，均将立即对您的账户等级生效（现已支持满级状态下正常使用，不再卡死）；自选物品兑换卡可任选一件商店在售物品进行兑换。\n\n本邮件发放对象为 2026-09-19 18:40:00 (UTC+8) 之前完成注册的账户；\n领取有效期截至 2026-09-26 23:59:59 (UTC+8)，逾期未领取将无法补发，请及时领取。\n\n再次感谢您的理解与支持，祝您使用愉快！',
                    attachments: [
                        {
                            name: '经验值补给卡 Ⅰ',
                            type: 'warehouse',
                    ...
                    startTime: "2026-09-19 18:40:00",
                    endTime: "2026-09-26 23:59:59",
                    requireRegisteredBefore: "2026-09-19 18:40:00"
                }
            ]
        },
    ],
